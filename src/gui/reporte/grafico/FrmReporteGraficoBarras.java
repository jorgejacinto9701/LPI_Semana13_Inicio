...
public class FrmReporteGraficoBarras extends JFrame implements ActionListener   {
	...
	private static Logger log = Logger.getLogger(FrmReporteGraficoBarras.class.getName());
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					FrmReporteGraficoBarras frame = new FrmReporteGraficoBarras();
	 ...
	 * Create the frame.
	 */
	public FrmReporteGraficoBarras() {
		...
		JLabel lblTitulo = new JLabel("Reporte de Barras");
	...
	protected void actionPerformedBtnFiltrarJButton(ActionEvent e) {
		...
		if (!fecIni.matches(Validaciones.FECHA)) {
			...
			//Diseño del reporte
			String jasper = "reporteBarras.jasper";	
			
			//Obtengo la ruta relativa de la imagen
			String rutaImagen = FrmReporteGraficoBarras.class.getResource("/logos/Mercedes_Logo_.jpg").getPath();
